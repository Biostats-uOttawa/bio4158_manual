---
title: "BIO4158 Applied biostats with R"
...
description: "Laboratory manual for BIO4158 Applied biostatistics"
github-repo: "Bio4158-4558-uottawa/lab_manual/"
...
This document was developped using the excellent [bookdown](https://bookdown.org/) `r emo::ji("package")` de [Yihui Xie](https://yihui.name/). The manual is based on the previous lab manual *Findlay, Morin and Rundle, BIO4158 Laboratory manual for BIO4158*.
