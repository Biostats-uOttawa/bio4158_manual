...
## t1* 1.1919926  0.001850216  0.03346385
## t2* 0.3408557 -0.001162455  0.02660344
\end{verbatim}
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 1.125,  1.256 )   ( 1.126,  1.257 )  
## 
## Level     Percentile            BCa          
## 95%   ( 1.127,  1.258 )   ( 1.120,  1.254 )  
...
## Intervals : 
## Level      Normal              Basic         
## 95%   ( 0.2899,  0.3942 )   ( 0.2900,  0.3923 )  
## 
## Level     Percentile            BCa          
## 95%   ( 0.2894,  0.3917 )   ( 0.2926,  0.4021 )  
## Calculations and Intervals on Original Scale
\end{verbatim}
...
## Bootstrap Statistics :
##      original      bias    std. error
## t1* 45.084391  0.02301701   0.4272076
## t2* -1.714546 -0.01057610   0.7625979
\end{verbatim}
...
\tightlist
\item
  \texttt{Iter} coefficient: the Prob stopping rule stopped after 1357 iterations. Note that this number will vary each time you run this snippet of code. These are random permutation results, so expect variability.
\item
  \texttt{Pr(Prob)} coefficient: The estimated probability associated to H0 is 0.0693 . The observed difference in fklngth between the two locations was larger than the permuted differences in about (1 - 0.0693= about 93.1\%) of the 1357 cases. Mind you, 1357 permutations is not a large number, so small p values can't be expected to be very precise. If it is critical that you get more precise p values, more permutations would be needed. Two parameters can be tweaked: maxIter, the maximum number of iterations (default=5000), and Ca, that stops iterations when estimated standard error of the estimated p is less than Ca*p.~Default 0.1.
\item
