...
```{r, stur-2, warning = FALSE, message =  FALSE, fig.cap = "Scatter plot of Weight as a function of length in sturgeons"}
mygraph <- ggplot(
...
```{r, stur-log, warning = FALSE, message =  FALSE, fig.cap = "Plot weight-length in sturgeon using a log scale"}
...
```{r, lm-pow-fig-1, fig.cap = "Power analysis for age-length in sturgeon with N = 20 and slope = 0.1", out.width = "100%", echo = FALSE  }
...
```{r, lm-pow-fig-2, fig.cap = "A priori power analysis to estimate the sample size needed to have a power of 0.99", out.width = "100%", echo = FALSE  }
